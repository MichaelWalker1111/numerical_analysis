...
from parameters_25_11 import f     #function
from parameters_25_11 import n     #number of iterations
from parameters_25_11 import ipt   #initial point
from parameters_25_11 import ipt2   #initial point
...
# Do not forget to include reasoning for the order of convergence


fil=open("answers_25_11.txt","a+")
for i in range(0, n):
